import a from './prigl_post.module.css'

function CrPrPost(){
    return(
        <div class={a.div_prPost}>
            <div class={a.div_pr_inf}>
                 <div class={a.div_inf_zapl}>
                    <h1>Приглашаем  к сотрудничеству производителей и поставщиков одежды, обуви и аксессуаров</h1>
                    <div class={a.inps}>
                   ...
                   <button >Отправить<svg xmlns="http://www.w3.org/2000/svg" width="26" height="5" viewBox="0 0 26 5" fill="none">
            ...
            <div class={a.elips}>
                <svg class={a.cr} xmlns="http://www.w3.org/2000/svg" width="100" height="201" viewBox="0 0 100 201" fill="none">
                ...
                <img class={a.cr1} src="./imgs/Ellipse 2.png" alt="" />
            </div>
        </div>
    )
}
