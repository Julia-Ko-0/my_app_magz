...
function CrElCard(props){
    ...
    function DelElem(){
        ...
        for(let i=0;i< props.ma.length;i++){
            if( props.ma[i].articul == props.articul &&  props.ma[i].size == props.size){
                props.ma[i].kolv--
                if( props.ma[i].kolv==0){
                    props.ma.splice(i,1)
    ...
    return(
        <section id={props.articul} class={a.ElTov}>
            ...
            <div>
                 ...
                 <button>Информация о доставке <svg xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
...
function  CrCard(){
    ...
    const [app,setApp] = useState(MasCard)
    const [kol,setCard] = useState(0)
    function Zacazat(){
        ...
        <div class={a.div}>
            <div class={a.div_ob_card}>
                ...
                <div class={a.div_card}>
                    ...
                    {
                    app.map(m=>(
                        <CrElCard  kolvs={kol} setCard_={setCard} ma= {app} setApp_={setApp} prs = {prices} ust = {setPrice} id={m.polz} skl={m.img} price={m.price} size={m.size}
                        color={m.color}
