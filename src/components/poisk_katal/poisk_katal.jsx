...
function CrPoiskKatal(){
    ...
    //     let NewMas =Mas
    //     console.log(Mas)
    //     let MMM = Mas.filter(a=> a.name.includes(ev))
    //                     SetCount(MMM)
    //                     console.log(MMM)
    ...
    //                     let infPol = document.getElementById('div_inf_polz')
    //                     if( infPol.style.display == 'grid'){
    //                         infPol.style.display = 'none'
    //                     }
    //                     else{
    //                         infPol.style.display = 'grid'
    //                     }
    ...
    return(
        <div>
         ...
         <div id='div2' class={a.div2}>
             {/* <div class={a.inp_d}>
                        <svg class={a.svg} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <NavLink to='/Каталог/?glOt=none&ot=none'>
                    <input  value={inp2Value} onChange={(e)=>{setInp2(e.target.value) 
                    ...
                    <NavLink to='/Корзина' ><svg class={a.svg} id='b_carz'xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <div class={a.img_left}>
                <img src="./imgs/rectangle-21.png"/>
                </div>
            <div class={a.btns} 
            onClick={()=>{
                   let poisk = document.getElementById('poisk')
